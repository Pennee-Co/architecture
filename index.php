...
<body>
	<div class="bg-g1 size1 flex-w flex-col-c-sb p-l-15 p-r-15 p-t-55 p-b-200 respon1">
		<span></span>
		<div class="flex-col-c p-t-50 p-b-50">
			...
			<button onclick="gotoMexxonProperties();" class="flex-c-m s1-txt2 size3  btn-danger"  data-toggle="modal" data-target="#subscribe">
				<h4>Mexxon Properties</h4>
			</button>
			...
			<button onclick="gotoMexxonJobSearch();" class="flex-c-m s1-txt2 size3 btn-primary"  data-toggle="modal" data-target="#subscribe">
				<h4>Mexxon Job Search</h4>
			</button>
		</div>

		<!--span class="s1-txt3 txt-center">
			Mexxon @ 2017 . Site By <a href="https://facebook.com/9jaloads">Redhoster</a>
		</span-->
	...
	<script>
		...
		function gotoMexxonProperties(){
			window.location.href = 'http://mexxon.com.ng';
    	return false;
		}
		function gotoMexxonJobSearch(){
